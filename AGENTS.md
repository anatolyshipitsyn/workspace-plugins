...
follow the Agent Plugins Specification v1.0.0. The portable manifest is
`plugin.json` at the plugin root. Skills belong under `skills/`, and portable
MCP configuration belongs in `mcp.json`.
